# Microsoft Developer Studio Project File - Name="nullgzip" - Package Owner=<4>
...
# Begin Custom Build - Copying nullgzip to tests folder
WkspDir=.
TargetName=nullgzip
InputPath=.\Release\nullgzip.exe
SOURCE="$(InputPath)"

"$(WkspDir)\tests\$(TargetName).exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
...
# Name "nullgzip - Win32 Release"
# Name "nullgzip - Win32 Debug"
